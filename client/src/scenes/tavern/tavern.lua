...
local function transitionToCreateStatsFromRace(raceId)
    pendingRace  = raceId
    pendingName  = ""
    pendingClass = nil
...
local function escapeFromRaceToMenu()
    sub = SUB.MENU
end

SUB.CREATE_RACE = require("src.scenes.tavern.createRace")({
    noop         = noop,
    drawHeader   = drawHeader,
    drawPartyPanel = drawPartyPanel,
    drawFooter   = drawFooter,
    postMessage  = postMessage,
    transitionToCreateStatsFromRace = transitionToCreateStatsFromRace,
    escapeToMenu = escapeFromRaceToMenu,
